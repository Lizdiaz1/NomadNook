    ...
    await Booking.bulkCreate(
      ...
      [
        ...
        },
        {
          spotId: 2,
          userId: 2,
          startDate: new Date("11-5-2024"),
          endDate: new Date("11-10-2024"),
        },
        {
          spotId: 2,
          userId: 2,
          startDate: new Date("09-01-2024"),
          endDate: new Date("09-07-2024"),
        },
        {
          spotId: 2,
          userId: 1,
          startDate: new Date("10-15-2024"),
          endDate: new Date("11-18-2024"),
        },
        {
          spotId: 2,
          userId: 3,
          startDate: new Date("11-22-2024"),
          endDate: new Date("22-02-2024"),
        },
        {
          spotId: 3,
          userId: 3,
          startDate: new Date("11-25-2024"),
          endDate: new Date("11-30-2024"),
        },
        {
          spotId: 3,
          userId: 3,
